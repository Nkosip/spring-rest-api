...
public class StudentController {
    ...
    public ResponseEntity<Student> student() {
        Student student = new Student(2,"Ram","Fadatare");
    ...
    public ResponseEntity<List<Student>> getStudents() {
        ...
        students.add(new Student(2,"Nkosi","Mbhele"));
        students.add(new Student(3,"Ümesh","Fadatare"));
        students.add(new Student(4,"Ram","Govender"));
